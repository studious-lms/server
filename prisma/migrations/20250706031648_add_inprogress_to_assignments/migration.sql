...
INSERT INTO "new_Assignment" ("classId", "createdAt", "dueDate", "eventId", "graded", "gradingBoundaryId", "id", "instructions", "markSchemeId", "maxGrade", "modifiedAt", "sectionId", "teacherId", "title", "type", "weight") SELECT "classId", "createdAt", "dueDate", "eventId", "graded", "gradingBoundaryId", "id", "instructions", "markSchemeId", "maxGrade", "modifiedAt", "sectionId", "teacherId", "title", "type", "weight" FROM "Assignment";
